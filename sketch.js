...
function draw() {
  ...
  // Press START to begin the web-based interaction.
  // STAY on this screen—please avoid swiping left or right.
  // Click the REFRESH button in the top left corner to restart for the next user.
  if (state == 0) {
